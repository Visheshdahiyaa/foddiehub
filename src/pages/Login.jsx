...
export function loadUsers() {
    try {
        ...
        // Always force admin account to have correct role and password as fallback
                    ...
                    <div className='p-6'>
                        ...
                        {tab === 'login' && (
                            <form onSubmit={handleLogin} className='space-y-4'>
                                ...
                                <button type='submit' className='w-full py-3 bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg transition-colors'>
                                    Sign In
                                </button>
                                <p className='text-center text-sm text-gray-500 dark:text-gray-400'>
                                    No account?{' '}
                                    <button type='button' onClick={() => switchTab('register')} className='text-green-600 font-semibold hover:underline'>
                                        Register here
                                    </button>
                                </p>
                            </form>
                        ...
                        {tab === 'register' && (
                            <form onSubmit={handleRegister} className='space-y-4'>
                                ...
                                <p className='text-center text-sm text-gray-500 dark:text-gray-400'>
                                    ...
                                    <button type='button' onClick={() => switchTab('login')} className='text-green-600 font-semibold hover:underline'>
                                        Sign in
                                    </button>
                                </p>
                            </form>
